  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <Button variant="link">View Summary</Button>
      </SheetTrigger>
      <SheetContent
      ...
      >
        <SheetHeader className="px-4 py-3">
          <div>
            ...
            <SheetDescription>
              Check out detailed performance metrics with chart visualizations
            </SheetDescription>
          </div>
        </SheetHeader>

        <div
          className="px-4 py-3 flex flex-col gap-4 h-full overflow-y-auto minimal-scrollbar"
        >
